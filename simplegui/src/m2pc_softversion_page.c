 ...
 * @LastEditors: xgj
 * @LastEditTime: 2023-08-09 20:54:41
 * @FilePath:
 * @Description: 
 * 
...
//=======================================================================//
HMI_SCREEN_OBJECT       g_stHMI_SoftVer_Page =  {   HMI_SCREEN_ID_SOFT_VER_PAGE,
                                                        &s_stDemoTextActions
                                                    };
...
static HMI_ENGINE_RESULT HMI_TextPage_RefreshScreen(SGUI_SCR_DEV* pstDeviceIF, const void* pstParameters)
{
    ...
    char buf[100] = {0};
    // sprintf(buf, "PC %s \r\n\r\nINV %s \r\n\r\nCARD %s", g_lcd_app_ctx.udp_ver, g_lcd_app_ctx.inv_ver, g_lcd_app_ctx.card_ver);
