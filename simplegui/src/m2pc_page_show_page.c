 ...
 * @LastEditors: xgj
 * @LastEditTime: 2023-07-10 17:16:29
 * @FilePath: \simplegui\DemoProc\src\m2pc_page_show_page.c
 * @Description: 工位板参数显示界面
 *
...
static HMI_SCREEN_ACTION       s_stDemoNoticeActions =         {   HMI_DemoNotice_Initialize,
...
//=======================================================================//
HMI_SCREEN_OBJECT       g_stHMIM2PC_ParaShow_Page =  {   HMI_SCREEN_ID_M2PC_PARA_SHOW_PAGE,
...
static HMI_ENGINE_RESULT HMI_DemoNotice_Initialize(SGUI_SCR_DEV* pstDeviceIF)
{
    ...
    s_stDemoNoticeBox.stLayout.iX = pstDeviceIF->stSize.iWidth / 2;
    s_stDemoNoticeBox.stLayout.iY = pstDeviceIF->stSize.iHeight / 2;
    s_stDemoNoticeBox.stLayout.iWidth = pstDeviceIF->stSize.iWidth;
    s_stDemoNoticeBox.stLayout.iHeight = pstDeviceIF->stSize.iHeight;
...
static HMI_ENGINE_RESULT HMI_DemoNotice_Prepare(SGUI_SCR_DEV* pstDeviceIF, const void* pstParameters)
{
    ...
    // SGUI_Notice_FitArea(pstDeviceIF, &(s_stDemoNoticeBox.stLayout));
    SGUI_Notice_Repaint(pstDeviceIF, &s_stDemoNoticeBox, &SGUI_DEFAULT_FONT_8, 0);
    return HMI_RET_NORMAL;
}
